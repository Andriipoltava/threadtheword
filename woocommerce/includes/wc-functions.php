...
function threadtheword_wrapper_product_entry_end(){
    ...
    <div class="product_desktop">
        ...
        <div class="share">
            ...
            <ul class="share_list">
                <li class="share_item">
                    <a href="#sub-menus"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-product-1.svg" alt=""></a>
                    <ul class="sub-share_list">
                        <li class="sub-share_item"><a href="<?php echo esc_url( $facebook_url ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-share-1.svg" alt=""></a></li>
                        <li class="sub-share_item"><a href="<?php echo esc_url( $twitter_url ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-share-2.svg" alt=""></a></li>
                        <li class="sub-share_item"><a href="<?php echo esc_url( $pinterest_url ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-share-3.svg" alt=""></a></li>
                        <li class="sub-share_item"><a href="<?php echo esc_url( $email_url ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-share-4.svg" alt=""></a></li>
                    </ul>
                </li>
                <li class="share_item">
                    <a href="<?php the_field('footer_bottom_facebook_link', 'options'); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-product-2.svg" alt=""></a>
                </li>
                <li class="share_item">
                    <a href="<?php the_field('footer_bottom_instagram_link', 'options'); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-product-3.svg" alt=""></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="product_mob">
            ...
            <div class="share">
                ...
                <ul class="share_list">
                    <li class="share_item">
                        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-product-1.svg" alt=""></a>
                    </li>
                    <li class="share_item">
                        <a href="<?php the_field('footer_bottom_facebook_link', 'options'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-product-2.svg" alt=""></a>
                    </li>
                    <li class="share_item">
                        <a href="<?php the_field('footer_bottom_instagram_link', 'options'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/icon-product-3.svg" alt=""></a>
                    </li>
                </ul>
            </div>
        </div>
