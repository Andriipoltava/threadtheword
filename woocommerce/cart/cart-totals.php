...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div cellspacing="0" class="shop_table shop_table_responsive">
		...
		<div class="cart-subtotal d-flex content-justify-between">
			<div><?php esc_html_e( 'Item Total', 'woocommerce' ); ?></div>
			<div data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></div>
		</div>

		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<div class="d-flex content-justify-between cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<div class="d-flex content-justify-between shipping">
		...
		<?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
			<div class="fee d-flex content-justify-between">
		...
		if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) {
			...
			if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) {
				foreach ( WC()->cart->get_tax_totals() as $code => $tax ) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
					?>
					<div class="d-flex content-justify-between tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				...
				?>
				<div class="d-flex content-justify-between tax-total">
    ...
    <div class="order-total">
        ...
        <div class="order-total-price" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?></div>
    </div>
